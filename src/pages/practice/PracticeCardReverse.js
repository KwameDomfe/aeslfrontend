...
const PracticeCardReverse = (props) => {
    ...
    return (
        ...
        > 
            <figure id=""
                className="gr1s1 gc1s7 grid items-center justify-center
                w-100 h-100 shadow-grey"
            >
                <img id=""
                    src={image}
                    alt=""
                    className="gc1s1 gr1s1 h-100 w-100 cover br0-50 br--left"
                />
            </figure>
            <div id="" 
                className="grid gr1s1 gc8s5 items-center justify-center
