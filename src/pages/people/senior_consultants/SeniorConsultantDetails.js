...
import seniorConsultant from '../../../images/practice/management/director-of-finance/dof-01.jpeg'
...
const SeniorConsultantDetails = () => {
    return (
        <div id=""
            class="min-vh-100 w-100">
        
            {/* <!-- Page Header --> */}
            <header id="senior_consultant_pageHeader"
                class="grid gtc12"
            >
                <figure class="gc1s12">
                    <img src={xxx}
                ...
                <hgroup class="gc1s12 w-100 blue0">
                    <h2 class="w-100 h-100
                        ...
                        f3-00
                        ">
                        Senior Consultant's Title and Name
                    </h2>     
                </hgroup>
            </header>
            {/* <!-- Page Header --> */}
            ...
            {/* <!-- Page Main --> */}
            <main id = "senior-consultant-pagemain"
                class="bg-white"
            >
                <div id="l_3:1" 
                ...
                >
                    {/* <!-- AESL History Start --> */}
                    <div id="lc_gc1s3__pageMain--SeniorConsultant"
                        class="gc1s3
                        min-vh-100
                        mb1-00"
                    >   
                        {/* <!-- Page Navigation --> */}
                        <div id="senior_consultants_summary"
                            class="pt2-00"
                        >
                            <div id="pageNav"
                        ...
                        {/* <!-- Senior Consultants --> */}
                        <div id="senior_consultant"
                            class="grid gtc12 ggap1-00
                                mb2-00"
                        >
                            <div id="senior_consultants_gallery"
                                class="gr1s1 gc1s12
                                    grid gtc12 ggap1-00
                                    mb2-00
                                    white-90"
                            >
                                <article id="people_senior_consultant_gallery_3" 
                                    class="gr1s1 gc1s6
                                            pa2-00
                                            white-90 bg-blue1"
                                >
                                ...
                                <article id="people_senior_consultant_gallery_4" 
                                    class="gr1s1 gc7s6
                                        pa2-00
                                        white-90 bg-blue1"
                                >
                            ...
                            {/* <!-- Senior Consultants Header --> */}

                            {/* <!-- Senior Consultants Description --> */}
                            <article id="senior_consultants_description" 
                                class="gr2s1 gc1s12"
                            > 
                                <div id=""
                            ...
                            <div id="people_senior_consultants_extra"
                                    class="gr3s1 gc1s12
                                        grid gtc12 ggap1-00
                                        mb2-00
                                        white-90"
                        ...
                        <section className="mb1-00">
                            <hgroup id="senior_consultants_related_projects"
                        ...
                        <SectionFooter sectionTitle = "People/Senior Consultants/Senior Consultant's Title and Name" />
                       
                        {/* <!--Related Projectss --> */}

                        {/* <!-- Senior Consultants Gallery -->  */}
                        <hgroup id="senior_consultants_lists"
                            class="gc1s12 w-100 blue0">
                            <h2 class="w-100 h-100
                                pv1-00 pb1-00 mb0-00
                                f3-00 ttu
                        ...
                        <div id="3x3_Grid_SeniorConsultants" 
                            class="grid gc1s12 ggap0-50 mb1-00 ttu"
                        >   
                            <article id="seniorConsultants_01" 
                                class="gr1s1 gc1s4
                                    flex items-center justify-center
                                    pa0-50 
                                    relative"
                            ...
                            <article id="seniorConsultants_02" 
                                class="gr1s1 gc5s4
                                    flex items-center justify-center
                                    pa0-50
                                    relative"
                            ...
                            <article id="seniorConsultants_03" 
                                class="gr1s1 gc9s4
                                    flex items-center justify-center
                                    pa0-50
                                    relative"
                            ...
                            <article id="seniorConsultants_04" 
                                class="gr2s1 gc1s4
                                    flex items-center justify-center
                                    pa0-50 
                                    relative"
                            ...
                            <article id="seniorConsultants_05" 
                                class="gr2s1 gc5s4
                                    flex items-center justify-center
                                    pa0-50
                                    relative"
                            ...
                            <article id="seniorConsultants_06" 
                                class="gr2s1 gc9s4
                                    flex items-center justify-center
                                    pa0-50
                                    relative"
                            ...
                            <article id="seniorConsultants_07" 
                                class="gr3s1 gc1s4
                                    flex items-center justify-center
                                    pa0-50 
                                    relative"
                            ...
                            <article id="seniorConsultants_08" 
                                class="gr3s1 gc5s4
                                    flex items-center justify-center
                                    pa0-50
                                    relative"
                            ...
                            <article id="seniorConsultants_09" 
                                class="gr3s1 gc9s4
                                    flex items-center justify-center
                                    pa0-50
                                    relative"
                        ...
                        {/* <!-- Page Footer --> */}
                        <SectionFooter 
                        sectionTitle = "Senior Consultants"
                        />
                        {/* <!-- Page Footer --> */}
                    </div>

                    {/* <!-- AESL History Aside  Start --> */}
                    <aside id="lc_gc4s1__pageAside--SeniorConsultant" 
                        class="gc4s1 
                            blue0 relative"
                    >
                        ...
                        >
                            ...
                            <ul class="mb1-00 bl bw4 b--green pl1-00 f0-75">
                                <h3 >On this page</h3>
                                <li class="mb1-00 i">
                                    <a href="#senior_consultants_summary"
                                    class="blue0"
                                    >
                                ...
                                <li class="mb1-00 i">
                                    <a href="#senior_consultants_gallery"
                                        class="blue0"
                                    >
                                        Senior Consultant's Gallery
                                    </a>
                                </li>
                                <li class="mb1-00 i">
                                    <a href="#senior_consultants_description"
                                    class="blue0"
                                    >
                                        Senior Consultant's Description
                                    </a>
                                </li>
                                <li class="mb1-00 i">
                                    <a href="#people_senior_consultants_extra"
                                        class="blue0"
                                    >
                                        Senior Consultant's Links
                                    </a>
                                </li>
                                    <li class="mb1-00 i">
                                    <a href="#senior_consultants_related_projects"
                                        class="blue0"
                                    >
                                        Related Projects
                                    </a>
                                ...
                                <li class="mb1-00 i">
                                    <a href="#senior_consultants_lists"
                                    class="blue0"
                                    >
                                        Senior Consultants Lists
                                    </a>
                                </li>
                            </ul>
                        </div>
            ...
            {/* <!-- Page Main -->  */}
            {/* Page Footer  */}
            <AESLPageFooter pageName = "Senior Consultant Details"/>
            {/* Page Footer  */}
        </div>
    )
}

export default SeniorConsultantDetails